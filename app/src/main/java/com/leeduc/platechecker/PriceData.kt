    ...
    val sections: List<TollSection> = listOf(
        TollSection(
            ...
            rows = listOf(
                ...
                TollRow("ĐT548 (Đồng Lộc, Can Lộc)", "147.000", "213.520", "287.666", "359.000", "572.000"),
                TollRow("ĐT550 (Thạch Hà - TP Hà Tĩnh)", "132.000", "193.000", "261.000", "325.000", "517.000"),
                TollRow("Cẩm Quan, Cẩm Xuyên", "117.000", "169.000", "228.000", "285.000", "453.000"),
                TollRow("Kỳ Trung, Kỳ Anh", "92.000", "131.000", "178.000", "222.000", "352.000"),
                TollRow("QL12C (Kỳ Tân, Kỳ Anh)", "80.000", "114.000", "155.000", "193.000", "307.000"),
                TollRow("Tiến Châu Văn Hóa", "52.000", "73.000", "100.000", "125.000", "198.000"),
        ...
        TollSection(
            ...
            rows = listOf(
                ...
                TollRow("9C (Cuối Lệ Thuỷ)", "32.000", "45.000", "59.000", "74.000", "118.000"),
                TollRow("9D (Vĩnh Linh - Bến Quan)", "43.000", "64.000", "85.000", "106.000", "170.000"),
                TollRow("ĐT75 (Cồn Tiên - Gio Linh)", "69.000", "94.000", "126.000", "157.000", "251.000"),
                TollRow("9A (Đông Hà - cam lộ, km740)", "78.000", "116.000", "154.000", "192.000", "307.000")
            )
        )
    )
}
